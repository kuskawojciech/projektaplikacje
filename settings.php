...
<head>
    ...
    <title>Ustawienia - Zarządzanie przedsiębiorstwem</title>
...
?>
        <div class="mask d-flex align-items-center h-100">
            ...
            <div class="alert alert-warning mt-1" role="alert">
                ...
                <strong>Jesteś zalogowany jako administrator!</strong> zmieniaj hasło ostrożnie, zmiana hasła może grozić utratą dostępu do panelu admina!
            </div>
        ERROR;
                    }
                    ?>
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6" style="padding-top: 40px;">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                <h2 class="text-uppercase text-center mb-5">Zmiana hasła</h2>

                                <form method="post" action="./scripts/passwordchg.php">

                                    <div class="form-outline mb-4">
                                        <input type="password" id="form3Example4cg" class="form-control form-control-lg" name="pass"/>
                                        <label class="form-label" for="form3Example4cg">Aktualne hasło</label>
                                    </div>
